...
STORAGE_LAUNCHERS = [
    {
        "release_bat": "storage_short_spec_generator_commercial_laptops.bat",
        "title": "Lenovo Commercial Laptop Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_commercial",
        "generated_text": "generated_storage_shortspec_rule_based_commercial",
        "output": "storage_shortspecs_rule_based_commercial_summary.xlsx",
    },
    {
        "release_bat": "storage_short_spec_generator_consumer_laptops.bat",
        "title": "Lenovo Consumer Laptop Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based_consumer.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_consumer",
        "generated_text": "generated_storage_shortspec_rule_based_consumer",
        "output": "storage_shortspecs_rule_based_consumer_summary.xlsx",
    },
    {
        "release_bat": "storage_short_spec_generator_tablet.bat",
        "title": "Lenovo Tablet Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based_tablet.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_tablet",
        "generated_text": "generated_storage_shortspec_rule_based_tablet",
        "output": "storage_shortspecs_rule_based_tablet_summary.xlsx",
    },
    {
        "release_bat": "storage_short_spec_generator_desktop.bat",
        "title": "Lenovo Desktop Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based_dt.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_dt",
        "generated_text": "generated_storage_shortspec_rule_based_dt",
        "output": "storage_shortspecs_rule_based_dt_summary.xlsx",
    },
    {
        "release_bat": "storage_short_spec_generator_thinkstation.bat",
        "title": "Lenovo ThinkStation Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based_thinkstation.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_thinkstation",
        "generated_text": "generated_storage_shortspec_rule_based_thinkstation",
        "output": "storage_shortspecs_rule_based_thinkstation_summary.xlsx",
    },
    {
        "release_bat": "storage_short_spec_generator_smb.bat",
        "title": "Lenovo SMB Storage ShortSpec",
        "script": "batch_generate_storage_shortspec_excel_rule_based_smb.py",
        "runtime_text": "runtime_spec_text_storage_rule_based_smb",
        "generated_text": "generated_storage_shortspec_rule_based_smb",
        "output": "storage_shortspecs_rule_based_smb_summary.xlsx",
    },
]
...
REM   - output one Storage-only summary worksheet for all products
...
if exist "%STORAGE_VENDOR_DEPS%\\pypdf" (
  if defined PYTHONPATH (
    set "PYTHONPATH=%STORAGE_VENDOR_DEPS%;%PYTHONPATH%"
  ) else (
    set "PYTHONPATH=%STORAGE_VENDOR_DEPS%"
  )
)
...
def release_dir_for_today(repo_root: Path) -> Path:
    return repo_root / "release" / f"storage_short_spec_generator_{datetime.now():%y%m%d}"
...
def sync_storage_pdf_deps(repo_root: Path, target_runtime: Path) -> None:
    target_vendor = target_runtime / "scripts" / "_storage_pdf_deps"
...
def sync_runtime(repo_root: Path, target_runtime: Path) -> None:
    ...
    sync_storage_pdf_deps(repo_root, target_runtime)


def write_release_readme(target_dir: Path) -> None:
    (target_dir / "README_storage_portable.txt").write_text(
        "\r\n".join(
            [
                "Storage ShortSpec Generator portable release.",
                "",
                "Copy this whole folder to another PC, then put full spec PDFs next to the required .bat launcher.",
                "Run the matching Storage .bat file. The output workbook is written next to the launcher.",
                "",
                "Delivered launchers:",
                "- storage_short_spec_generator_commercial_laptops.bat",
                "- storage_short_spec_generator_consumer_laptops.bat",
                "- storage_short_spec_generator_tablet.bat",
                "- storage_short_spec_generator_desktop.bat",
                "- storage_short_spec_generator_thinkstation.bat",
                "- storage_short_spec_generator_smb.bat",
                "",
...
def zip_release(target_dir: Path) -> Path:
    ...
    generated_workbooks = {config["output"] for config in STORAGE_LAUNCHERS}
...
def main() -> None:
    ...
    (target_dir / ".storage_shortspec_portable_package").write_text(
        "folder_portable_storage_only\n",
        encoding="utf-8",
    )

    for config in STORAGE_LAUNCHERS:
