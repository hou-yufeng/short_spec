...
OUTPUT_DIR = REPO_ROOT / "analysis_output" / "consumer_eval"
...
REPORT_PATH = OUTPUT_DIR / "training_data_consumer_evaluation.md"
DETAILS_PATH = OUTPUT_DIR / "training_data_consumer_evaluation_details.json"
